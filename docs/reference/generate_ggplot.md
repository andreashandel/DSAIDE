...
calling the
[`run_model`](https://andreashandel.github.io/DSAIDE/reference/run_model.md)
function (as done when going through the UI) or manually transforming
the output from a simulate\_ function into the correct list structure as
explained here.
